...
extern void __assert_fail // RUN: rm -rf %t.klee-out || echo "ok"
...
// CHECK: [FALSE POSITIVE] FOUND FALSE POSITIVE AT(const char *__assertion, const char *__file,
...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "68-longjmp_05-heap-counting-return-one-method_true.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
