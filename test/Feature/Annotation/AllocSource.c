...
int main() {
  ...
  maybeAllocSource1(a);
  // CHECK-ALLOCSOURCE1: Not Allocated
...
#ifdef AllocSource2
  maybeAllocSource2(&a);
  // CHECK-NOT-ALLOCSOURCE2 : memory error: null pointer exception
  // CHECK-NOT-ALLOCSOURCE2: Not Allocated
...
#ifdef AllocSource3
  a = maybeAllocSource3();
  // CHECK-NOT-ALLOCSOURCE3 : memory error: null pointer exception
...
#ifdef AllocSource4
  a = *maybeAllocSource4();
  // CHECK-NOT-ALLOCSOURCE4: memory error: null pointer exception
  // CHECK-NOT-ALLOCSOURCE4: Not Allocated
  // CHECK-ALLOCSOURCE4 : memory error: out of bound pointer
  // CHECK-ALLOCSOURCE4: partially completed paths = 1
  // CHECK-ALLOCSOURCE4: generated tests = 1
#endif
