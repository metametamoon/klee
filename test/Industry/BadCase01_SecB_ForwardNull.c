...
// RUN: %klee --output-dir=%t.klee-out --execution-mode=error-guided --mock-external-calls --libc=klee --skip-not-lazy-and-symbolic-pointers --check-out-of-memory --analysis-reproduce=%s.json %t1.bc
