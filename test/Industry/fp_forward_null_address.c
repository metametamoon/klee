...
// RUN: %klee --output-dir=%t.klee-out --max-cycles=150 --execution-mode=error-guided --mock-external-calls --skip-not-lazy-and-symbolic-pointers --max-time=120s --analysis-reproduce=%s.json %t1.bc
