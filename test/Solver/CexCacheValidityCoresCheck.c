...
// RUN: %klee --output-dir=%t1.klee-out --search=bfs --use-guided-search=none --cex-cache-validity-cores=false --solver-backend=z3 %t1.bc
// RUN: %klee --output-dir=%t2.klee-out --search=bfs --use-guided-search=none --cex-cache-validity-cores=true --solver-backend=z3 %t1.bc
