...
// RUN: %klee --write-kqueries --output-dir=%t.klee-out --libc=klee --posix-runtime --skip-not-lazy-initialized --skip-not-symbolic-objects --min-number-elements-li=4 %t.bc > %t.log
