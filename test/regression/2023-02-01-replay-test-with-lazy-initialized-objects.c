...
// RUN: %klee --output-dir=%t.klee-out --libc=klee --posix-runtime --skip-not-lazy-initialized --skip-not-symbolic-objects --min-number-elements-li=3 --min-element-size-li=8 %t.bc > %t.log
