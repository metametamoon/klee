...
Statistic stats::merges("Merges", "Merges");
Statistic stats::failedMerges("FailedMerges", "FailedMerges");
Statistic stats::openMerges("OpenMerges", "OpenMerges");
Statistic stats::closeMerges("CloseMerges", "CloseMerges");
Statistic stats::statesWithMerge("StatesWithMerge", "StatesWithMerge");
Statistic stats::reachedMerge("ReachedMerge", "ReachedMerge");
